        ...
        with open("bn6f.gba", "rb") as rom_file:
            ...
            for sprite_pointer_address in range(0x08031cec, 0x80329a8, 4):
                ...
                for animation_index in range(animation_count):
                    (animation_animoffset,) = unpack_at_offset(animation_table_rom_offset + animation_index * 4, "<I")
                    if animation_animoffset > 0x10000:
                        # probably not a valid sprite.
                        print(f"!!! animation_table_rom_offset={animation_table_rom_offset:#08x} animation_animoffset={animation_animoffset:#x}")
                        continue
                    ...
                    if tile_set_animoffset > 0x10000:
                        # probably not a valid sprite.
                        print(f"!!! tile_set_animoffset={tile_set_animoffset:#x}")
                        continue
